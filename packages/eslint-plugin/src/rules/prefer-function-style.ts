...
import type { ArrowFunctionExpression, FunctionExpression, Identifier, VariableDeclaration } from 'estree'
			...
			VariableDeclaration(varDecl) {
				...
				context.report({
					...
					fix(fixer) {
						...
						const generatorMark = fnNode.type === 'FunctionExpression' && fnNode.generator ? '*' : ''
